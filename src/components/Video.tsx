        ...
        <div className="p-8 max-w[1100px] mx-auto">
            ...
            Nessa aula vamos dar início ao projeto criando a estrutura base da aplicação utilizando ReactJS, Vite e TailwindCSS. Vamos também realizar o setup do nosso projeto no GraphCMS criando as entidades da aplicação e integrando a API GraphQL gerada pela plataforma no nosso front-end utilizando Apollo Client.
                    ...
                    <div className="flex items-center gap-4 mt-6 ">
                        ...
                        src="https://avatars.githubusercontent.com/u/101880897?v=4" 
                        alt="" 
                        />

                        <div className="leadind-relaxed">
                            <strong className="font-bond text-2xl block">Adriana Latorre</strong>
                            <span className="text-gray-200 text-sm block">Programming Student | Web Developer Full Stack</span>
                        </div>
            ...
            <div className="gap-8 mt-20 grid-cols-2">
                ...
                <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                    ...
                    <div className="py-6 leadind-relaxed">
